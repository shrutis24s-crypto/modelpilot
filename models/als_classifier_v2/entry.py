"""
ModelPilot Entry Script - ALS Classifier V2 (Random Forest Tuned)
Loads ALS FUS biomarker data from /app/input/als_data.csv,
runs the tuned RF pipeline, saves output.json to /app/output/
"""
...
print("=" * 55)
print("ModelPilot | ALS Biomarker Classifier V2 (RF Tuned)")
print("=" * 55)
...
output = {
    ...
    "model": "RandomForestClassifier_v2_tuned",
