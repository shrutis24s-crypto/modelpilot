"""
ModelPilot Entry Script - ALS Classifier SVM
Loads ALS FUS biomarker data from /app/input/als_data.csv,
runs the SVM pipeline, saves output.json to /app/output/
"""
...
print("=" * 55)
print("ModelPilot | ALS Biomarker Classifier (SVM - RBF)")
print("=" * 55)
...
output = {
    ...
    "model": "SupportVectorMachine_RBF",
